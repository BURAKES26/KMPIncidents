...
fun IncidentDetailScreen(
    ...
    DisposableEffect(Unit) { onDispose { viewModel.clearCurrentIncident() } }
...
private fun DeleteButton(onDelete: () -> Unit) {
    OutlinedButton(
        ...
        Text(
            text = stringResource(Res.string.delete_incident_button),
            fontSize = 16.sp,
            fontWeight = FontWeight.SemiBold
        )
    }
    ...
    Card(
        ...
        Column(
            ...
            Column(
                ...
                DateInfoRow(
                    label = stringResource(Res.string.updated),
                    date = formatDateForDisplay(incident.updatedAt)
                )

                DateInfoRow(
                    label = stringResource(Res.string.due),
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.reported_by),
                    fontSize = 11.sp,
                    fontWeight = FontWeight.Bold,
                    color = Color(0xFF6B7280),
                    letterSpacing = 0.8.sp
                ...
                incident.isAnonymous || incident.reportedBy == null -> {
                    Surface(
                        ...
                        Row(
                            ...
                            Text(
                                text = stringResource(Res.string.anonymous_report),
                                fontSize = 16.sp,
                                fontWeight = FontWeight.SemiBold,
                ...
                userFetchTimeout -> {
                    Surface(
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(Res.string.failed_to_retrieve_user_information),
                                fontSize = 14.sp,
                                fontWeight = FontWeight.SemiBold,
                                color = Color(0xFFDC2626)
                            )
                            Text(
                                text = stringResource(Res.string.request_timed_out_please_try_again),
                                fontSize = 12.sp,
