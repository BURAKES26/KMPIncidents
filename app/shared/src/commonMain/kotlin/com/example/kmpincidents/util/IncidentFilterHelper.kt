...
object IncidentFilterHelper {
    ...
    fun filterIncidents(
        ...
        return incidents.filter { incident ->
            ...
            val matchesPriority = priorityFilter.isEmpty() || priorityFilter.contains(incident.priority)
            val matchesStatus = statusFilter.isEmpty() || statusFilter.contains(incident.status)
            val matchesCategory = categoryFilter.isEmpty() || categoryFilter.contains(incident.category)
