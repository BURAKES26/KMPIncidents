...
import com.example.kmpincidents.ui.icons.DeleteIcon
                    ...
                    Row(
                        ...
                        verticalAlignment = Alignment.CenterVertically
                            ...
                            Surface(
                                ...
                                Text(
                                    text = stringResource(Res.string.due) + ": " + IncidentDisplayHelper.formatDateForDisplay(incident.dueAt),
...
fun EmptyState() {
    Box(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = stringResource(Res.string.try_adjusting_your_search_or_filters),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
